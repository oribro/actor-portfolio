    ...
    <div dir="rtl" className="font-sans bg-gray-50 text-gray-900 min-h-screen">
      ...
      <section className="max-w-3xl mx-auto py-16 px-6">
        ...
        <p className="text-lg leading-relaxed">
          ...
          ומתרוצץ בכל הארץ כשחקן, מאלתר, מנחה לאלתור ונגן. אני אוהב לצחוק, לנסות
          להביא אמת, לאכול מנגו בשל עם הקליפה מעל הכיור באימפולסיביות ותשוקה
          באופן שמצריך סליל שלם של חוט דנטלי לאחר מכן כדי להתאושש ועוד. בשנים
          האחרונות אני משחק במספר תיאטראות ובסרטי קולנוע עצמאיים (בינתיים ;).
        ...
        <p className="text-lg leading-relaxed">
          ...
          מן הון להון נבחרתי לשחק במופע, ולא לנגן על התופים, ועוד את התפקיד
          הראשי. אני לא זוכר הרבה מאותו ערב, חוץ מהתחושה הזו של חשמל. כל מצמוץ,
          כל תזוזה קטנה בזווית הפה- והקהל מגיב. משהו מעניין קרה שם. ברגע שעמדתי
          שם על הבמה לראשונה כשחקן ולא כנגן ידעתי (סורי על הקלישאתיות, הכי
          אמיתי) - "הכלי הבא שאלמד לנגן עליו הוא אני". והשאר היסטוריה.
        </p>
      </section>
